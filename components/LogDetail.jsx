...
///add pics to portfoliodta array
const LogDetail = ({ log, onClose }) => (
  ...
  >
    ...
    <div className="flex flex-col md:flex-row gap-6">
      <a href={log.liveUrl} target="_blank" rel="noreferrer" className="border border-[#00ff41] px-8 py-2 text-[#00ff41] hover:bg-[#00ff41] hover:text-black transition-all font-bold">DEPLOY_LIVE</a>
      <a href={log.githubUrl} target="_blank" rel="noreferrer" className="border border-white px-8 py-2 text-white hover:bg-white hover:text-black transition-all font-bold">VIEW_SOURCE</a>
