...
import { SYSTEM_CREDENTIALS } from '../portfolioDta'; // Import core credentials

const OfficerID = ({ onAccess, isMobile }) => {
  // Generate an ID string or fallback to a standard format based on data
    ...
    >
      <div className="flex gap-4 items-center">
        ...
        <div className="relative w-10 h-10 md:w-12 md:h-12 bg-[#1a1a1a] border border-[#00ff41] overflow-hidden">
          <img 
            src="/profile.jpg" // Keeping portrait routing local to public/
